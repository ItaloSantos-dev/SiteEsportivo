...
@section('content')
    <div class="container py-4">
        <h1 class="text-center mb-4 fw-bold">Growth</h1>
        <div class="row g-4 flex-nowrap overflow-scroll">
            @foreach($growth as $produto)
    ...
    <div class="container py-4">
        <h1 class="text-center mb-4 fw-bold">Darkness</h1>
        <div class="row g-4 flex-nowrap overflow-scroll">
            @foreach($darknes as $produto)
                @if($produto->variacoes->first()->estoque > 0)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                        <div class="card shadow-sm rounded-3 w-100 d-flex flex-column h-100">
    ...
    <div class="container  py-4">
        <h1 class="text-center mb-4 fw-bold">Mith</h1>
        <div class="row g-4 flex-nowrap overflow-scroll">
            @foreach($mith as $produto)
                @if($produto->variacoes->first()->estoque > 0)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                        <div class="card shadow-sm rounded-3 w-100 d-flex flex-column h-100">
    ...
    <div class="container py-4">
        <h1 class="text-center mb-4 fw-bold">Max titanium</h1>
        <div class="row g-4 flex-nowrap overflow-scroll">
            @foreach($max as $produto)
                @if($produto->variacoes->first()->estoque > 0)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                        <div class="card shadow-sm rounded-3 w-100 d-flex flex-column h-100">
    ...
    <div class="container  py-4">
        <h1 class="text-center mb-4 fw-bold">Integral</h1>
        <div class="row g-4 flex-nowrap overflow-scroll">
            @foreach($integral as $produto)
                @if($produto->variacoes->first()->estoque > 0)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                        <div class="card shadow-sm rounded-3 w-100 d-flex flex-column h-100">
