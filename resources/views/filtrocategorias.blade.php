...
@section('content')
    <div class="container  py-4">
        <h1 class="text-center mb-4 fw-bold">Nutrição</h1>
        <div class="row g-4 flex-nowrap overflow-scroll">
            @foreach($nutricao as $produto)
    ...
    <div class="container  py-4">
        <h1 class="text-center mb-4 fw-bold">Vestiário</h1>
        <div class="row g-4 flex-nowrap overflow-scroll">
            @foreach($vestiario as $produto)
                @if($produto->variacoes->first()->estoque > 0)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                        <div class="card shadow-sm rounded-3 w-100 d-flex flex-column h-100">
    ...
    <div class="container  py-4">
        <h1 class="text-center mb-4 fw-bold">Farmacos</h1>
        <div class="row g-4 flex-nowrap overflow-scroll">
            @foreach($farmacos as $produto)
                @if($produto->variacoes->first()->estoque > 0)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                        <div class="card shadow-sm rounded-3 w-100 d-flex flex-column h-100">
    ...
    <div class="container  py-4">
        <h1 class="text-center mb-4 fw-bold">Ergogênicos</h1>
        <div class="row g-4 flex-nowrap overflow-scroll">
            @foreach($ergogenicos as $produto)
                @if($produto->variacoes->first()->estoque > 0)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex">
                        <div class="card shadow-sm rounded-3 w-100 d-flex flex-column h-100">
